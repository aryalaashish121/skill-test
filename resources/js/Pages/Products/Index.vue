          ...
          <li v-for="product in props.products" :key="product.id">
            <div class="block hover:bg-gray-50">
              <div class="px-4 py-4 flex items-center sm:px-6">
                ...
                <div class="ml-5 flex-shrink-0 row-auto">
