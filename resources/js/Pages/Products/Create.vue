                        ...
                        <form @submit.prevent="form.post(route('products.store'))">
                            <div class="shadow sm:rounded-md sm:overflow-hidden">
                                ...
                                <div>
                                    ...
                                    <input class="block mb-5 w-full text-xs text-gray-900 bg-gray-50 rounded-lg border  cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                           :class="form.errors.image?'border-red-500':'border-gray-500'"

                                    id="product_image" v-on:input="form.image = $event.target.files[0]" type="file">
                                    </div>
